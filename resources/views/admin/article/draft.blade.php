            ...
            <div class="p-6">
                <div class="block max-w-full p-6 bg-gray-800 border border-gray-800 rounded-lg shadow-sm ">
                    <div class="flex justify-start">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">List Draft Article</h5>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <a href="{{ route('admin.article.status', $a->id) }}" class="font-medium text-green-600 dark:text-green-500 hover:underline">Publish</a>
